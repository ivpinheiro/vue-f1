            ...
            <div class="card login-background text-dark" style="border-radius: 1rem;">
              <div class="card-body p-3 text-center">
                ...
                <div class=" pb-5">
                  ...
                  <p class="text-dark-50 mb-3">Por favor, insira suas credenciais corretamente para ter acesso ao sistema!
                  </p>

                  <div class="form-outline form-dark mb-4">
                    <input v-model="input.username" type="email" id="typeEmailX" class="form-control form-control-lg"
                      placeholder="Login" @keypress="handleKeyPress" required />
                  </div>

                  <div class="form-outline form-dark mb-4">
                    <input v-model="input.password" type="password" id="typePasswordX"
                      class="form-control form-control-lg" placeholder="Senha" @keypress="handleKeyPress" required />
                  </div>
