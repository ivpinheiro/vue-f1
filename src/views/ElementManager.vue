    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col">
                ...
                <p class="fst-italic">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus eaque saepe libero, porro alias dolore maxime, ea sit voluptas vitae consequuntur suscipit corrupti aliquam natus nisi ad. Aperiam, quae ab?
                </p>
                <form>
                    <div class="row">
                        <div class="col-md-6">
